...
public class DocumentBuilderSafePropertyTest  extends BaseDetectorTest {
    ...
    public void detectUnsafePartialConfiguration() throws Exception {
        ...
        verify(reporter).doReportBug(
                bugDefinition()
                        .bugType("XXE_DOCUMENT")
                        .inClass("DocumentBuilderSafeProperty").inMethod("unsafeManualConfig1").atLine(92)
                        .build()
        );
        ...
        verify(reporter).doReportBug(
                bugDefinition()
                        .bugType("XXE_DOCUMENT")
                        .inClass("DocumentBuilderSafeProperty").inMethod("unsafeManualConfig2").atLine(105)
                        .build()
        );
        ...
        verify(reporter).doReportBug(
                bugDefinition()
                        .bugType("XXE_DOCUMENT")
                        .inClass("DocumentBuilderSafeProperty").inMethod("unsafeManualConfig3").atLine(118)
                        .build()
        );
        ...
        verify(reporter).doReportBug(
                bugDefinition()
                        .bugType("XXE_DOCUMENT")
                        .inClass("DocumentBuilderSafeProperty").inMethod("unsafeManualConfig4").atLine(131)
                        .build()
        );
        ...
        verify(reporter).doReportBug(
                bugDefinition()
                        .bugType("XXE_DOCUMENT")
                        .inClass("DocumentBuilderSafeProperty").inMethod("unsafeManualConfig5").atLine(144)
                        .build()
        );
    }
    ...
    public void safeWithUseOfEntityResolver() throws Exception {
        //Locate test code
        String[] files = {
                getClassFilePath("testcode/xxe/DocumentBuilderSafeEntityResolver"),
                getClassFilePath("testcode/xxe/DocumentBuilderSafeEntityResolver$CustomResolver")
        };
        ...
        verify(reporter, never()).doReportBug(
                bugDefinition()
                        .bugType("XXE_DOCUMENT")
                        .inClass("DocumentBuilderSafeEntityResolver").inMethod("receiveXMLStream")
                        .build()
        );
    }
