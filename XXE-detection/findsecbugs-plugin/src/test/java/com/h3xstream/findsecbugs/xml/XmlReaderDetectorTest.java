...
public class XmlReaderDetectorTest extends BaseDetectorTest {
    ...
    public void safeWithUseOfEntityResolver() throws Exception {
        //Locate test code
        String[] files = {
                getClassFilePath("testcode/xxe/XmlReaderSafeEntityResolver"),
                getClassFilePath("testcode/xxe/XmlReaderSafeEntityResolver$CustomResolver")
        };
        ...
        verify(reporter, never()).doReportBug(
                bugDefinition()
                        .bugType("XXE_DOCUMENT")
                        .inClass("XmlReaderSafeEntityResolver").inMethod("receiveXMLStream")
                        .build()
        );
    }
