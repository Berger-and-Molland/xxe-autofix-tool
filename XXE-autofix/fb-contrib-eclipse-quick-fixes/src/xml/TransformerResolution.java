...
public class TransformerResolution extends AbstractInstanceTrackResolution {
    ...
    public List<NodeToFind> addNodesToFind() {
        return Arrays.asList(
                new NodeToFind("TransformerFactory", "newInstance", true),
                new NodeToFind("Transformer", "newTransformer", false)
                );
    }
